...
## v1.1.0-dinner - 2026-09-17

- 首次发布离线晚饭抽签：12 类、60 种食物，五种模式、偏好保存与重抽彩蛋。
- 新增四个独立页面，以薯条、汉堡、饮料与皇冠雪人装饰，提供中英文玩法与刷入说明。
- 发布已测试的 1.1.0-dinner 完整合并固件；实机首页和抽取已确认，其余实机验收项
  在验收报告中列明。

## 继承的上游模板记录

以下上游待发布记录早于本应用首版，作为模板历史保留，不属于本应用此次更新。
